    ...
    async with SolWalletAgent() as agent:
        try:
            ...
            yaml_content = {
                ...
                "get_sol_wallet_assets_test": {"input": agent_input_assets, "output": agent_output_assets},
                "get_sol_tx_history_test": {"input": agent_input_tx, "output": agent_output_tx},
                "analyze_sol_token_holders_test": {"input": agent_input_holders, "output": agent_output_holders},
            }
