...
| CoinGeckoTokenInfoAgent | This agent can fetch token information, market data, and trending coins from CoinGecko. | • get_coingecko_id<br>• get_token_info<br>• get_trending_coins<br>• get_token_price_multi | [Source](./mesh/coingecko_token_info_agent.py) | Coingecko |
...
| SolWalletAgent | This agent can query Solana wallet assets and recent swap transactions using Helius API. | • get_sol_wallet_assets<br>• analyze_sol_token_holders<br>• get_sol_tx_history | [Source](./mesh/sol_wallet_agent.py) | Helius |
